...
/**
 * Implementierung des Spring Security UserDetailsService für benutzerdefinierte Authentifizierung.
 */
@Service
public class CustomUserDetailsService implements UserDetailsService {
     ...
     * @throws UsernameNotFoundException Falls kein Benutzer mit dem angegebenen Benutzernamen gefunden wird.
     */
    @Override
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
        // Ruft den Nutzer anhand des Benutzernamens aus dem Repository auf oder wirft einen Fehler, wenn kein Benutzer gefunden wird
        ...
        // Erstellt und gibt ein Spring Security User-Objekt zurück, basierend auf den Benutzerdaten aus der Datenbank
