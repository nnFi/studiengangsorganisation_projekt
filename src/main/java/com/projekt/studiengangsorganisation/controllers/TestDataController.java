...
public class TestDataController {
         ...
         * 
         * @return Eine Bestätigungsnachricht, dass die Datenbank erfolgreich geleert
         */
        @PostMapping("/clear")
        public String clearData() {
                clearDatabase();

                return "Datenbank wurde erfolgreich geleert!";
        }
        ...
        public List<Fachgruppe> insertTestFachgruppen(Fachbereich fachbereich, Mitarbeiter referent,
                ...
                List<Fachgruppe> fachgruppen = Arrays.asList(
                                ...
                                createFachgruppe("Controlling, Finanz- und Rechnungswesen", "CFR", fachbereich,
                                                referent,
                                                stellvertreter),
                                createFachgruppe("Mathematik und Statistik", "M/S", fachbereich, referent,
                                                stellvertreter),
                                ...
                                createFachgruppe("Personal und Organisation", "P/O", fachbereich, referent,
                                                stellvertreter),
                                createFachgruppe("Produktion und Logistik", "P/L", fachbereich, referent,
                                                stellvertreter),
         ...
         */
        public Studiengang insertTestStudiengang(Mitarbeiter leiter, Mitarbeiter stellvertreter,
         ...
         */
        public void insertSemester1Modules(List<Fachgruppe> fachgruppen, Mitarbeiter beauftragter,
                        Modulgruppe modulgruppe,
                        Pruefungsordnung pruefungsordnung) {
                insertModuleAndPruefung("BWL für Wirtschaftsinformatik", 150, 6,
                                getFachgruppeByKuerzel(fachgruppen, "MG"),
                                beauftragter, modulgruppe, pruefungsordnung, 1, 1);
                insertModuleAndPruefung("Externes Rechnungswesen und Finanzierung", 150, 6,
                                getFachgruppeByKuerzel(fachgruppen, "CFR"), beauftragter, modulgruppe, pruefungsordnung,
                                2, 1);
                insertModuleAndPruefung("Mathematik für Wirtschaftsinformatik", 150, 6,
                                getFachgruppeByKuerzel(fachgruppen, "M/S"), beauftragter, modulgruppe, pruefungsordnung,
                                3, 1);
         ...
         * @param pruefungsordnung Die zugehörige Prüfungsordnung.
         */
        public void insertSemester2Modules(List<Fachgruppe> fachgruppen, Mitarbeiter beauftragter,
                        Modulgruppe modulgruppe,
                        Pruefungsordnung pruefungsordnung) {
                insertModuleAndPruefung("Materialwirtschaft und Produktionsplanung/-steuerung", 150, 6,
                                getFachgruppeByKuerzel(fachgruppen, "WI"), beauftragter, modulgruppe, pruefungsordnung,
                                5, 2);
                ...
                insertModuleAndPruefung("Systementwicklung", 300, 12, getFachgruppeByKuerzel(fachgruppen, "WI"),
                                beauftragter,
         ...
         * @param pruefungsordnung Die zugehörige Prüfungsordnung.
         */
        public void insertSemester3Modules(List<Fachgruppe> fachgruppen, Mitarbeiter beauftragter,
                        Modulgruppe modulgruppe,
                        Pruefungsordnung pruefungsordnung) {
         ...
         * @param pruefungsordnung Die zugehörige Prüfungsordnung.
         */
        public void insertSemester4Modules(List<Fachgruppe> fachgruppen, Mitarbeiter beauftragter,
                        Modulgruppe modulgruppe,
                        Pruefungsordnung pruefungsordnung) {
         ...
         * @param pruefungsordnung Die zugehörige Prüfungsordnung.
         */
        public void insertSemester5Modules(List<Fachgruppe> fachgruppen, Mitarbeiter beauftragter,
                        Modulgruppe modulgruppe,
                        Pruefungsordnung pruefungsordnung) {
                insertModuleAndPruefung("Englisch für Wirtschaftsinformatik", 150, 6,
                                getFachgruppeByKuerzel(fachgruppen, "SP"), beauftragter, modulgruppe, pruefungsordnung,
                                18, 5);
         ...
         * @param pruefungsordnung Die zugehörige Prüfungsordnung.
         */
        public void insertSemester6Modules(List<Fachgruppe> fachgruppen, Mitarbeiter beauftragter,
                        Modulgruppe modulgruppe,
                        Pruefungsordnung pruefungsordnung) {
        ...
        private Fachgruppe getFachgruppeByKuerzel(List<Fachgruppe> fachgruppen, String kuerzel) {
                return fachgruppen.stream()
                                ...
                                .orElseThrow(() -> new RuntimeException(
                                                "Fachgruppe mit Kürzel " + kuerzel + " nicht gefunden"));
        }
        ...
        private void insertModuleAndPruefung(String modulName, int workload, int credits, Fachgruppe fachgruppe,
                        ...
                        Modulgruppe modulgruppe, Pruefungsordnung pruefungsordnung, int pruefungsnummer,
                        int fachsemester) {
